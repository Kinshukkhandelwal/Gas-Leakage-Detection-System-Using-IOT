#include <SoftwareSerial.h>
  ...
  String apiKey = "1HYMOTBQTROZCYCW";     // replace with your channel's thingspeak WRITE API key

  String ssid="minor";    // Wifi network SSID

  String password ="123456123456";  // Wifi network password
